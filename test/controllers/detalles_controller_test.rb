...
class DetallesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle" do
    assert_difference('Detalle.count') do
      post detalles_url, params: { detalle: { Libros_id: @detalle.Libros_id, Prestamos_id: @detalle.Prestamos_id, cantidad: @detalle.cantidad } }
    end
  ...
  test "should update detalle" do
    patch detalle_url(@detalle), params: { detalle: { Libros_id: @detalle.Libros_id, Prestamos_id: @detalle.Prestamos_id, cantidad: @detalle.cantidad } }
